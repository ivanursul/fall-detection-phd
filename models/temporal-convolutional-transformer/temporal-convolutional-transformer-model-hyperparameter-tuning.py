...
# Map the best hidden_dim and num_heads from the string key
hidden_dim_num_heads_str = best_params['hidden_dim_num_heads']
best_hidden_dim, best_num_heads = hidden_dim_num_heads_map[hidden_dim_num_heads_str]
...
best_model = TemporalConvolutionalTransformerModel(input_dim, best_num_heads, best_num_layers, num_classes,
                                                   hidden_dim=best_hidden_dim, tcn_channels=[64, 64],
