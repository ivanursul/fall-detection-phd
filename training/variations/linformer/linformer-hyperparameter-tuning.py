...
hidden_dim_num_heads_map = {
    '2_1': (2, 1), '4_1': (4, 1), '4_2': (4, 2), '8_1': (8, 1), '8_2': (8, 2), '8_4': (8, 4),
    '12_1': (12, 1), '12_2': (12, 2), '12_4': (12, 4), '16_1': (16, 1), '16_2': (16, 2),
    '16_4': (16, 4), '16_8': (16, 8), '24_2': (24, 2), '24_4': (24, 4), '24_8': (24, 8),
    '32_2': (32, 2), '32_4': (32, 4), '32_8': (32, 8), '32_16': (32, 16), '40_4': (40, 4),
    '40_8': (40, 8), '48_4': (48, 4), '48_8': (48, 8), '64_4': (64, 4), '64_8': (64, 8),
    '64_16': (64, 16), '128_4': (128, 4), '128_8': (128, 8), '128_16': (128, 16)
}
...
def objective(trial):
    ...
    if hidden_dim % num_heads != 0:
        raise optuna.exceptions.TrialPruned(f"hidden_dim {hidden_dim} is not divisible by num_heads {num_heads}")
    ...
    model = LinformerTransformerModel(input_dim, num_heads, num_layers, num_classes, hidden_dim=hidden_dim, dropout=dropout, max_sequence_length=max_sequence_length).to(device)
...
best_model = LinformerTransformerModel(input_dim, num_heads, num_layers, num_classes).to(device)
